...
using DetailsViewTemplateDemo.DataModel;
...
namespace DetailsViewTemplateDemo
{
    public class ViewModel : NotificationObject
    {
        ...
        {
            Random r = new Random();
            Northwind north = new Northwind(@"..\..\Northwind.sdf");

            foreach (OrderDetails orderDet in north.OrderDetails.Take(35))
            {
                ...
                if (!(_orderList.Any(order => order.OrderID == orderInfo.OrderID)))
